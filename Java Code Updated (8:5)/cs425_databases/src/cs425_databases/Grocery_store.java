...
public class Grocery_store {
	...
	public Object [][] getProductData() { // Add "ResultSet rs" as parameter later
			  
		num_items = 30;
		  
		Object [][] data = { 
			{_getImage("oreo.jpeg"), "Oreo Milk Cookies", "2.0 cu. ft.", "$3.99", "See More", "0", "+"},
			{_getImage("oreo.jpeg"), "Oreo Milk Cookies", "2.0 cu. ft.", "$3.99", "See More", "0", "+"},
			{_getImage("oreo.jpeg"), "Oreo Milk Cookies", "2.0 cu. ft.", "$3.99", "See More", "0", "+"},
			{_getImage("oreo.jpeg"), "Oreo Milk Cookies", "2.0 cu. ft.", "$3.99", "See More", "0", "+"},
			{_getImage("oreo.jpeg"), "Oreo Milk Cookies", "2.0 cu. ft.", "$3.99", "See More", "0", "+"},
	...
	// To be done by Suleyma
	public Object [][] getOfferData() { // Add "ResultSet rs" as parameter later
				  
		// There should always be only 8 offers
			  
		Object [][] data = { 
			{_getImage("oreo.jpeg"), "$3.99", "+"},
			{_getImage("oreo.jpeg"), "$3.99", "+"},
			{_getImage("oreo.jpeg"), "$3.99", "+"},
			{_getImage("oreo.jpeg"), "$3.99", "+"},
			{_getImage("oreo.jpeg"), "$3.99", "+"},
